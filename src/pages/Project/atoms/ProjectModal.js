...
import {getProjectData, useProjectDispatch, useProjectState } from "../../../context/ProjectContext";
                ...
                <section>
                    ...
                    <main>
                        ...
                        <ModalContainer>
                            ...
                            <Box>참여 인원 및 프로젝트 role<br /> 참여 인원 및 프로젝트 role<br /> 참여 인원 및 프로젝트 role</Box>
                        </ModalContainer>
                        <ModalContainer>
                        ...
                        <ModalContainer>
                            ...
                            <Box>{projectData.startDate} ~ {projectData.endDate}</Box>
                        </ModalContainer>
                        <ModalContainer>
                            <Text padding={46}>기술스택</Text>
                            <Box>{projectData.techStack}기술스택 <br /> 기술스택</Box>
                        </ModalContainer>
                        <ModalContainer>
